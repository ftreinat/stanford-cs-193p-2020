...
//    //a way to initialize a state inside an init
...
//        \.self ist ein Keypath und gibt ein Attribut eines Objektes an. Hier self
                    ...
                    Image(systemName: "doc.on.clipboard").imageScale(.large)
                        .alert(isPresented: self.$explainBackgroundPaste) {
                            return Alert(
                                ...
                                message: Text("Copy the URL of an image to the clipboard and touch this button to make the background of your document."),
    ...
    //Better use an enum with the two different alert typse instead of the bools here. Then you can also use the identifier init from alert instead
    ...
    private var zoomScale: CGFloat {
        document.steadyStateZoomScale * gestureZoomScale.zoomScaleBackground
    }
